...
import LinerBox from "./LinerBox";
import HoloGram2 from "./HoloGram2";
    ...
    <div style={{ height: "100vh", overflow: "hidden" }}>
      ...
      >
        ...
        <BackgroundNew position={[50, 0, -30]} />
          <HoloGram position={[-2.3, 4.90, -20]}  />
          <HoloGram2 position={[-2.3, 4.90, -20]} />
              <LinerBox position={[-1, 4.85, -20]}  />
              
          {/* position={[0, -0.1, 4.4]}   */}

        {/* <HolaSpesh position={[-100, 0, 16]} /> */}

        <ScrollControls pages={6} distance={1.5} damping={0.4}>
          ...
          <Scroll html style={{ position: "absolute", width: "100vw" }}>
            ...
            {/* ---------bg gradient  / text type animation ----------- */}
            <section class="  border-x-violet-950 border-y-violet-950 min-h-[60vh] mt-[15px] rounded-2xl	md:container md:mx-auto lg:container lg:mx-auto ">
                ...
                <div class="col-span-2">
                  <div className="lg:col-start-1 lg:col-span-6 pl-20 pt-20 items-center text-base justify-center">
                    <div className="h-[300px] pt-[50px]">
                      <h1 className="text-4xl font-semibold txt-gradient leading-[95px]	">
                        {" "}
                        <HeroText />
                      </h1>
                    </div>

                    <div class="flex flex-row  text-md font-semibold	 rounded text-violet-500 mt-4">
            ...
            <section className=" md:container md:mx-auto lg:container lg:mx-auto mb-32 pl-24 mt-[250px]">
            ...
            <section class="text-gray-600 body-font md:container md:mx-auto lg:container lg:mx-auto pl-20">
            ...
            {/* ---------what we offer Animation area / services row over BOX  ----------- */}
            <section>
